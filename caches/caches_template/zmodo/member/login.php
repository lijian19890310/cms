...
.login_hd{ width: 550px; text-align: center; margin: 100px auto 10px auto;}
.login_w{ background: url(<?php echo IMG_PATH;?>bkg_mb_logbox.png) no-repeat; width: 550px; height:418px; margin: 0 auto;}
...
.form-login{ padding: 160px 30px 0 30px; width: 450px; margin: 0 auto;}
.onShow, .onFocus, .onError, .onCorrect, .onLoad, .onTime{ position: absolute; left: 300px; width: 130px; }
.form-login h2{font-size:25px;color:#494949;border-bottom: 1px dashed #CCC;padding-bottom:3px; margin-bottom:10px}
.form-login .input{ position: relative; padding:3px 0; background: #FFF; border-radius: 3px; border: 1px solid #bbd5e4; margin: 10px 0; box-shadow: 0 1px 1px #FFFFFF; width: 300px;}
.form-login .input label{ width:84px;font-size:14px; font-family: "微软雅黑","宋体",sans-serif; color:#145891; text-align:right}
.take,.reg{padding:0 0 0 0; overflow: hidden; _zoom:1;}
.btn_set{ height: 45px;}
.btn_set .save_info{ margin: 15px 0 0 10px;}
...
.input-text, .input-focus{ font-size: 16px; padding: 4px 0 4px 5px; background: none; border: 0; border-left: 1px solid #bbd5e4; width: 180px;}
.submit{ width: 135px; margin: 10px 0 0 40px;}
.submit input{ display: block; background: url(<?php echo IMG_PATH;?>btn_mb_login.jpg) no-repeat; height:32px; width:135px; cursor: pointer; overflow: hidden; text-indent: -200px; font-size: 0; line-height: 0;}
.submit input{ border:none; padding:0 10px 0 7px; font-size:14px}
...
.form-login .checkcode{ position: relative; width: 200px;}
.checkcode .input-text, .checkcode .input-focus{ width: 80px;}
#code_img{ position: absolute; left: 210px; top:5px;}
...
<div id="content">
    <div class="login_hd"><img src="<?php echo IMG_PATH;?>mb_login_hd.png" alt="" /> </div>
    <div class="login_w">
        <div class="form-login" id="logindiv">
            <form method="post" action="" onsubmit="save_username();" id="myform" name="myform">
                ...
                <div class="take">
                    <div class="btn_set">
                        <div class="left submit"><input type="submit" name="dosubmit" id="dosubmit" value="<?php echo L('login');?>"></div>
                        <div class="left save_info"><input type="checkbox" name="cookietime" value="2592000" id="cookietime"><!--<?php echo L('remember');?><?php echo L('username');?>-->记住登录信息</div>
                    </div>
                </div>
            </form>
        </div>
