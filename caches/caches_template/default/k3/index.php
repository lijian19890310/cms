		...
		<form action="index.php" method="GET">
				...
				<input type="hidden" name="a" value="result"/>
				  <div id="type" style="height:40px;">
				    	<input type="radio" id="radio1" name="type" value="1" checked="checked"/><label for="radio1">物料名称</label>
				    	<input type="radio" id="radio2" name="type" value="2"  /><label for="radio2">物料代码</label>
					<input type="radio" id="radio3" name="type" value="3"/><label for="radio3">规格</label>
				  </div>
				<span class="s_ipt_wr">
